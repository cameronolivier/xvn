...
- **Switching Output**: Changed version switch success message text from green to blue for better visual hierarchy
- **Color Contrast**: Improved readability by using blue for descriptive text while keeping green checkmark
