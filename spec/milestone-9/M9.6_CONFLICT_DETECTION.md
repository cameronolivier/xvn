...
- [ ] Show warning in init/setup
- [ ] Store conflict state
- [ ] Show warning on activate
- [ ] Clear warning when resolved
- [ ] Don't warn for single installation
- [ ] Ignore ~/.xvn/bin/xvn symlink
...
- ✅ Detects npm, Homebrew, and Cargo installations
- ✅ Warns user during init/setup
- ✅ Shows persistent warning on activate
- ✅ Warning clears when conflicts resolved
- ✅ No false positives (ignores ~/.xvn/bin/xvn)
- ✅ User understands how to resolve conflicts
